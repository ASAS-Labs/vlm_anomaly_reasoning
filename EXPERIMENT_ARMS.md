...
- SFT on expectation generation: leave-scene-out FAILED, within-scenario 0.936 (Part 18)
  — the concepts are learnable but do not transfer across scenes; further SFT needs
  more scenes per concept (dataset design), not more variants.
